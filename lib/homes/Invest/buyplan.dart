                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("25% profit for 3 months",style: Stylings.titles.copyWith(fontSize: 12),),
                                Text("Earns you 25% profit in 3 months",style: Stylings.subTitles.copyWith(fontSize: 10,color: Colors.grey.shade400),),
                              ],
                            ),
                            const Expanded(child: SizedBox()),
                            const Icon(Icons.check_circle_outline_sharp,size: 20,color: Colors.green,)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("50% profit for 6 months",style: Stylings.titles.copyWith(fontSize: 12),),
                                Text("Earns you 50% profit in 6 months",style: Stylings.subTitles.copyWith(fontSize: 10,color: Colors.grey.shade400),),
                              ],
                            ),
                            const Expanded(child: SizedBox()),
                            const Icon(Icons.check_circle_outline_sharp,size: 20,color: Colors.green,)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("75% profit for 12 months",style: Stylings.titles.copyWith(fontSize: 12),),
                                Text("Earns you 75% profit in 12 months",style: Stylings.subTitles.copyWith(fontSize: 10,color: Colors.grey.shade400),),
                              ],
                            ),
                            const Expanded(child: SizedBox()),
                            const Icon(Icons.check_circle_outline_sharp,size: 20,color: Colors.green,)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("50% profit for 3 months",style: Stylings.titles.copyWith(fontSize: 12),),
                                Text("Earns you 50% profit in 3 months",style: Stylings.subTitles.copyWith(fontSize: 10,color: Colors.grey.shade400),),
                              ],
                            ),
                            const Expanded(child: SizedBox()),
                            const Icon(Icons.check_circle_outline_sharp,size: 20,color: Colors.green,)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("85% profit for 6 months",style: Stylings.titles.copyWith(fontSize: 12),),
                                Text("Earns you 85% profit in 6 months",style: Stylings.subTitles.copyWith(fontSize: 10,color: Colors.grey.shade400),),
                              ],
                            ),
                            const Expanded(child: SizedBox()),
                            const Icon(Icons.check_circle_outline_sharp,size: 20,color: Colors.green,)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("98% profit for 12 months",style: Stylings.titles.copyWith(fontSize: 12),),
                                Text("Earns you 98% profit in 12 months",style: Stylings.subTitles.copyWith(fontSize: 10,color: Colors.grey.shade400),),
                              ],
                            ),
                            const Expanded(child: SizedBox()),
                            const Icon(Icons.check_circle_outline_sharp,size: 20,color: Colors.green,)
