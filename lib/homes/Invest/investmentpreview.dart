...
class _InvestmentpreviewState extends State<Investmentpreview> {
  @override
  void initState() {
   Get.find<Jollofx>().planDetails();
  //print(Get.find<Jollofx>().planAt[0],);
    super.initState();
  }
  @override
          ...
          children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text("${Get.find<Jollofx>().investmentDurationAt.value==0?"3":Get.find<Jollofx>().investmentDurationAt.value==1?'6':'12'} months",style: Stylings.titles.copyWith(fontSize: 12),),
                            Text("This investment would stay for ${Get.find<Jollofx>().investmentDurationAt.value==0?"3":Get.find<Jollofx>().investmentDurationAt.value==1?'6':'12'} months",style: Stylings.subTitles.copyWith(color: Colors.grey.shade400,fontSize: 10),
                            )],
                        ),
                  ...
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        ...
                        // SizedBox(height: 5,),
                      Text("\$${Get.find<Jollofx>().investmentAmount.value.toInt()}",style: Stylings.titles.copyWith(fontSize: 15),)
                      ],
                    ),
                  ),
                ],
                  ...
                  Container(
                    ...
                    child:Row(
                      ...
                      children: [
                        ...
                        const Expanded(flex:2,child: SizedBox()),
                        Text("${Get.find<Jollofx>().planAt[Get.find<Jollofx>().investmentDurationAt.value]}%",style: Stylings.titles.copyWith(fontSize: 12,color: Colors.green)),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text("Start with \$${Get.find<Jollofx>().investmentAmount.value.toInt()}",style: Stylings.titles.copyWith(fontSize: 12),),
              ),
            ),
          ],
        ),
