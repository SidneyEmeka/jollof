                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text("In ${Get.find<Jollofx>().investmentDetailsReturned['duration']} months",style: Stylings.titles.copyWith(fontSize: 11),)
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text("\$${NumberFormat.decimalPattern('en').format(((Get.find<Jollofx>().investmentAmount)*(75/100)))}",style: Stylings.titles.copyWith(fontSize: 12)),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Expanded(flex:2,child: SizedBox()),
                        Text("\$${NumberFormat.decimalPattern('en').format(Get.find<Jollofx>().investmentDetailsReturned['amount_invested'])}",style: Stylings.titles.copyWith(fontSize: 12)),
                      ],
                    ),
                  ),
                  //Interest
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Expanded(flex:2,child: SizedBox()),
                        Text("\$${NumberFormat.decimalPattern('en').format(Get.find<Jollofx>().investmentDetailsReturned['expected_interest'])}",style: Stylings.titles.copyWith(fontSize: 12,color: Colors.green)),
                      ],
                    ),
                  ),
                  //Rate
                  Container(
                    ...
                    child:Row(
                      ...
                      children: [
                        ...
                        const Expanded(flex:2,child: SizedBox()),
                       Text("\$${NumberFormat.decimalPattern('en').format(Get.find<Jollofx>().investmentDetailsReturned['total_return_amount'])}",style: Stylings.titles.copyWith(fontSize: 12,color: Colors.green)),
                      ],
                    ),
                  ),
                ],
